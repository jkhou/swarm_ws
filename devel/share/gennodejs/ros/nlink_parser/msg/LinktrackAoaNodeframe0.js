...
class LinktrackAoaNodeframe0 {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.nodes.forEach((val) => {
      bufferOffset = LinktrackAoaNode0.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LinktrackAoaNodeframe0(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.nodes[i] = LinktrackAoaNode0.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LinktrackAoaNodeframe0(null);
    ...
    if (msg.nodes !== undefined) {
      ...
      for (let i = 0; i < resolved.nodes.length; ++i) {
        resolved.nodes[i] = LinktrackAoaNode0.Resolve(msg.nodes[i]);
      }
    }
    else {
      resolved.nodes = []
...
module.exports = LinktrackAoaNodeframe0;
