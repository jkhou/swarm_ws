...
(cl:defclass <LinktrackAoaNodeframe0> (roslisp-msg-protocol:ros-message)
  ((role
    :reader role
    :initarg :role
    :type cl:fixnum
   ...
   (nodes
    :reader nodes
    :initarg :nodes
    :type (cl:vector nlink_parser-msg:LinktrackAoaNode0)
   :initform (cl:make-array 0 :element-type 'nlink_parser-msg:LinktrackAoaNode0 :initial-element (cl:make-instance 'nlink_parser-msg:LinktrackAoaNode0))))
)

(cl:defclass LinktrackAoaNodeframe0 (<LinktrackAoaNodeframe0>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <LinktrackAoaNodeframe0>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'LinktrackAoaNodeframe0)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nlink_parser-msg:<LinktrackAoaNodeframe0> is deprecated: use nlink_parser-msg:LinktrackAoaNodeframe0 instead.")))

(cl:ensure-generic-function 'role-val :lambda-list '(m))
(cl:defmethod role-val ((m <LinktrackAoaNodeframe0>))
...
(cl:defmethod id-val ((m <LinktrackAoaNodeframe0>))
...
(cl:defmethod local_time-val ((m <LinktrackAoaNodeframe0>))
...
(cl:defmethod system_time-val ((m <LinktrackAoaNodeframe0>))
...
(cl:defmethod voltage-val ((m <LinktrackAoaNodeframe0>))
...
(cl:defmethod nodes-val ((m <LinktrackAoaNodeframe0>))
  ...
  (nodes m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <LinktrackAoaNodeframe0>) ostream)
  "Serializes a message object of type '<LinktrackAoaNodeframe0>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LinktrackAoaNodeframe0>) istream)
  "Deserializes a message object of type '<LinktrackAoaNodeframe0>"
  ...
  (cl:let ((vals (cl:slot-value msg 'nodes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'nlink_parser-msg:LinktrackAoaNode0))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LinktrackAoaNodeframe0>)))
  "Returns string type for a message object of type '<LinktrackAoaNodeframe0>"
  "nlink_parser/LinktrackAoaNodeframe0")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LinktrackAoaNodeframe0)))
  "Returns string type for a message object of type 'LinktrackAoaNodeframe0"
  "nlink_parser/LinktrackAoaNodeframe0")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<LinktrackAoaNodeframe0>)))
  "Returns md5sum for a message object of type '<LinktrackAoaNodeframe0>"
  "0f131ffd1a11760ff33ff513bfedb13a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'LinktrackAoaNodeframe0)))
  "Returns md5sum for a message object of type 'LinktrackAoaNodeframe0"
  "0f131ffd1a11760ff33ff513bfedb13a")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LinktrackAoaNodeframe0>)))
  "Returns full string definition for message of type '<LinktrackAoaNodeframe0>"
  (cl:format cl:nil "uint8 role~%uint8 id~%uint32 local_time~%uint32 system_time~%float32 voltage~%LinktrackAoaNode0[] nodes~%~%================================================================================~%MSG: nlink_parser/LinktrackAoaNode0~%uint8 role~%uint8 id~%float32 dis~%float32 angle~%float32 fp_rssi~%float32 rx_rssi~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LinktrackAoaNodeframe0)))
  "Returns full string definition for message of type 'LinktrackAoaNodeframe0"
  (cl:format cl:nil "uint8 role~%uint8 id~%uint32 local_time~%uint32 system_time~%float32 voltage~%LinktrackAoaNode0[] nodes~%~%================================================================================~%MSG: nlink_parser/LinktrackAoaNode0~%uint8 role~%uint8 id~%float32 dis~%float32 angle~%float32 fp_rssi~%float32 rx_rssi~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <LinktrackAoaNodeframe0>))
  (cl:+ 0
     1
     1
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <LinktrackAoaNodeframe0>))
  "Converts a ROS message object to a list"
  (cl:list 'LinktrackAoaNodeframe0
